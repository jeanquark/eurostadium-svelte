export default function (stadiumObj, stadiums, leagues) {
    ...
    for (let i = 0; i < stadiums.length; i++) {
        ...
        newElement.setAttribute('cx', stadiums[i]['x'])
        // newElement.setAttribute('cy', stadiums[i]['venue']['y'])
        newElement.setAttribute('cy', stadiums[i]['y'])
        ...
        newElement.setAttribute('data-api-football-league-id', stadiums[i]['id'])
        // newElement.setAttribute('data-api-football-venue-id', stadiums[i]['venue']['api_football_id'])
        newElement.setAttribute('data-api-football-venue-id', stadiums[i]['id'])
        newElement.setAttribute('data-city', stadiums[i]['city'])
        newElement.setAttribute('data-capacity', stadiums[i]['capacity'])
