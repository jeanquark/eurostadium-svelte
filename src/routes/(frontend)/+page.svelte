<script>
    ...
    import EuropeSimplify from '@lib/components/svg/EuropeSimplify.svelte'
    ...
    let { title = 'eurostadium.net', description = 'Football stadiums across Europe', image = 'https://eurostadium.net/images/logo.png' } = $props()
    ...
    const countryClick = async (event) => {
        ...
        const abc = $stadiumStore.stadiumsByCountry[countrySlug].filter((el) => el.leagues[0].api_football_id == country.leagues[0]['api_football_id'])
        console.log('abc: ', abc)
        stadiums = abc
...
<svelte:head>
    ...
    <meta property="og:url" content="https://www.eurostadium.net{$page.url.pathname.toString()}" />
    ...
    <meta property="twitter:domain" content="https://www.eurostadium.net" />
    <meta property="twitter:url" content="https://www.eurostadium.net{$page.url.pathname.toString()}" />
...
<div class="row my-0 py-0 justify-content-center border-0" style="position: relative;">
    <div class="col-sm-1 col-md-2 col-lg-3 col-xl-3 hidden-sm-and-down border-0" style=""></div>
    <div class="col-sm-10 col-md-8 col-lg-6 col-xl-6 border-primary border-radius-1" style="background: #FFF;">
        ...
        {:else}
            <div class="border-radius-08" style="">
    ...
    <div class="col-sm-1 col-md-2 col-lg-3 col-xl-3 justify-center align-content d-xs-none hidden-sm-and-down border-0">
        {#if showFilterButtons}
