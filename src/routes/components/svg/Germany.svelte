...
<svg
    ...
    id="map-germany"
    viewBox="0 0 791.99896 791.99896"
    width="400"
    class=""
>
    <defs id="defs4">
    ...
    <g>
        ...
        <path
            ...
            title="Bremen"
            class="land"
            d="m 266.72658,198.37432 0.72,-0.1 v 0 l 6.18,1.69 -1.23,2.18 2.79,2.05 13.14,0.83 2.17,3.48 5.17,-2.19 2.46,2.73 -2.24,1.09 2.65,2.01 -0.55,5.41 -2.93,3.42 -4.4,-2.78 -2.81,2.1 -3.19,-3.5 -3.43,1.47 -6.32,-13.54 -6.92,-3.24 v 0 0 0 l -1.31,-3.24 v 0 z m 1.94,-40.43 8.9,-0.44 -2.71,3.76 0.96,8.47 -3.74,1 -1.17,-3.99 v 0 l 1.42,-1.84 z"
        />
        <path
            id="DE-HH"
            title="Hamburg"
            class="land"
            d="m 345.72658,163.15432 2.61,-8.03 4.15,4.85 4.48,-7.05 4.61,0.65 1.28,-3.73 4.24,0.34 1,-4.55 5.61,-1.96 1.53,1.58 -3.13,4.92 4.96,4.72 -1.46,5.15 -3.06,1.35 0.71,5.43 3.14,0.19 7.34,7.69 -1.13,1.65 v 0 l -4.43,3.98 h -4.1 l -7.81,-7.18 -4.28,5.05 -4.43,0.25 -0.76,-4.51 -2.67,2.8 -3.48,-3.55 -2.09,-9.68 z"
        />
        <path
            id="DE-HE"
            title="Hesse"
