<script>
    ...
    $effect(async () => {
        ...
        const parentCountrySlug = "france";
        const stadiumApiFootballId = 20470;
        ...
        if (countryStadiums.length > 0) {
            ...
            countryStadiumsArray[0]["stadium"]["x"] = 280;
            countryStadiumsArray[0]["stadium"]["y"] = 910;
            addStadiumsToSvgMap(
                stadiumObj,
